...
func (w Walking) Calories() float64 {
	...
	srSpeed := math.Pow(w.meanSpeed()*KmHInMsec, 2)
	return ((CaloriesWeightMultiplier*w.Weight + (srSpeed/heightInM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
